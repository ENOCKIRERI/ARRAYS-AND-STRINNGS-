...
let f=['Enock','Georege','Jillian','Rachael'];
console.log(f.includes('Brenda'));
console.log(f.includes('Enock'));
/*The join() method creates and returns a new string by concatenating all
 of the elements in an array.*/
 let g = ['Enock','Georege','Jillian','Rachael'];
let gString = g.join(', ');
console.log(gString); 
...
let array = ['enock', 'enock', 3, 2, 4, 1, 5, 3];
let duplicates = [];
...
let name='racecar'
console.log(isnamePalindrome('racecar')); // Output: true
